document.addEventListener("DOMContentLoaded", function() {
  ...
  const navLinks = document.querySelector(".nav-links");  /************************************************Dark Mode Toggle and Banner Swap
***********************************************/
  ...
  updateBanner(savedTheme);  // Toggle theme on button click
  ...
  }  /************************************************Transparent Header on Mobile Scroll
***********************************************/
...
hamburger.classList.remove("scrolled-mobile");
 ...
 hamburger.classList.remove("scrolled-mobile");
  ...
  /************************************************Hamburger Overlay (Partial Screen)
***********************************************/
  ...
  overlay.innerHTML = overlayNavHTML;  hamburger.addEventListener("click", () => {
    overlay.classList.toggle("show");
  });  overlay.querySelectorAll("a").forEach(link => {
    link.addEventListener("click", () => {
      overlay.classList.remove("show");
    });
  });  /************************************************"Shop & Contribute" Popup - Modified
***********************************************/
  function createPopup() {
 console.log("Creating popup...");
 let mobileButtonsOverlay = document.createElement("div");
 mobileButtonsOverlay.id = "mobileButtonsOverlay";
mobileButtonsOverlay.innerHTML = `  <div class="mobile-buttons-content">
...
setTimeout(() => {
  ...
  mobileButtonsOverlay.classList.add("show");
    ...
    createPopup();
  }  /************************************************Advanced About Page Slider with Continuous Audio and Auto-Restart
***********************************************/
...
function prevSlide() {
  ...
  }  /************************************************Home Page Video (Click-to-toggle-audio)
***********************************************/
...
***********************************************/
 ...
 alert("Coming soon");
  ...
  }  /************************************************Fix anchor links for Contribute and Volunteer
***********************************************/
...
behavior: 'smooth'
  ...
  window.addEventListener('hashchange', handleHashScroll);  console.log("Script fully initialized!");
});
